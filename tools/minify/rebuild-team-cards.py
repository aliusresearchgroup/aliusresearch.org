...
/* Grid — explicit track counts + explicit minmax() row heights so that
   grid-template-columns / grid-template-rows can be natively animated
   from fr-sized defaults to pixel-sized emphasis when we expand a cell. */
body.wsite-page-team .team-grid {
  ...
  margin: 0 auto;
  padding: 24px;
  transition: grid-template-columns 1800ms cubic-bezier(0.22, 0.61, 0.36, 1),
              grid-template-rows 1800ms cubic-bezier(0.22, 0.61, 0.36, 1);
}
