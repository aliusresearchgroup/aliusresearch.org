...
/* --- Click-to-expand interaction (driven by team-card-expand.js) --- */
body.wsite-page-team .team-card {
  cursor: pointer;
...
/* Dim + shrink neighbouring cards when any card is expanded */
...
/* Expanded card: spans full grid row, wider padding, side-by-side layout */
body.wsite-page-team .team-card--expanded {
  ...
  box-shadow: 0 12px 40px -8px rgba(26, 77, 46, 0.25),
...
body.wsite-page-team .team-card--expanded .team-card__avatar {
  ...
  height: 180px;
  margin: 0;
  box-shadow: 0 0 0 4px #3d8b3d, 0 6px 18px rgba(0, 0, 0, 0.12);
}
body.wsite-page-team .team-card--coord.team-card--expanded .team-card__avatar {
  box-shadow: 0 0 0 4px #8fbf4d, 0 6px 18px rgba(0, 0, 0, 0.12);
}
...
body.wsite-page-team .team-card--expanded .team-card__bio {
  ...
  font-size: 15px !important;
  line-height: 1.7 !important;
  /* Animate from clamped height to pre-measured expanded height */
  max-height: var(--expanded-bio-height, 80ex);
  transition: max-height 320ms cubic-bezier(0.22, 0.61, 0.36, 1);
  text-align: left !important;
}
body.wsite-page-team .team-card--expanded .team-card__links {
  justify-content: flex-start;
  padding-top: 14px;
  margin-top: 14px;
  border-top: 1px solid rgba(0, 0, 0, 0.08);
}
body.wsite-page-team .team-card--expanded .team-card__links::before {
...
/* Full-screen backdrop so clicks outside any card collapse (and dims the rest of the page subtly) */
.team-card-backdrop {
  position: fixed;
  inset: 0;
...
body.team-card-backdrop--active .team-card-backdrop {
  background: rgba(15, 26, 17, 0.1);
  pointer-events: auto;
}
...
@media (max-width: 640px) {
  ...
  body.wsite-page-team .team-card--expanded .team-card__avatar { margin: 0 auto; }
  body.wsite-page-team .team-card--expanded .team-card__name,
  body.wsite-page-team .team-card--expanded .team-card__role,
  body.wsite-page-team .team-card--expanded .team-card__bio {
    text-align: center !important;
  }
  body.wsite-page-team .team-card--expanded .team-card__links { justify-content: center; }
}
</style>
